...
for presentation in src/presentations/*; do
    ...
    docker run --rm --net=host -t -v $(pwd):/slides cchet/decktape:3.1.0 reveal --size=1920x1080 --pause 2000 --load-pause 2000 http://localhost:8080 docs/$(basename $presentation).pdf
